...
include_once('FirebaseAuthentication_ShortCodeLoader.php');
 ...
 */
abstract class FirebaseAuthentication_ShortCodeScriptLoader extends FirebaseAuthentication_ShortCodeLoader {
